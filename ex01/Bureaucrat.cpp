...
/*   Updated: 2025/12/10 21:42:51 by tatahere         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Bureaucrat::Bureaucrat(std::string name, int grade)
{
	...
	this->_name = name;
	if (grade < 1)
		throw Bureaucrat::GradeTooHighException("grade too high for initiaization.");
	if (grade > 150)
		throw Bureaucrat::GradeTooLowException("grade too low for initialization.");
	this->_grade = grade;
}
